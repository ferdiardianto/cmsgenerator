...
<div class="container">
    <ol class="breadcrumb">
      ...
      <li class="active">Buat Group User</li>
    </ol>
    <div class="panel panel-default">
        <div class="panel-body">
             @if(Session::has('success'))
                ...
                @endif     
            <form action="{{ url() }}/group_user/store" id="form" role="form" method="post">
                <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="hidden" name="id_group" class="input-xlarge" placeholder="" value="" />
                            <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                            <input type="text" name="nm_group" class="form-control" placeholder="" value="" />
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <select id='web_id' style="width:100%" name="web_id[]"  multiple="multiple">
                                ...
                                ?>  
                                        <option value="{{ $row->id }}">{{ $row->website_name }}</option>
                                <?php
                                    endforeach;
                                ?>
                            </select>
